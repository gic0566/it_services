                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($companyArr as $k => $v): ?>
                                                <tr>
                                                    ...
                                                    <th><?php echo $v['id']; ?></th>
                                                    <th><a href="<?php echo \Yii::$app->urlManager->createUrl(['/user/company-detail', 'id' => $v['id']]); ?>"><?php echo $v['name']; ?></a></th>
                                                    <th><img src="<?php echo $v['logo']; ?>" width="50" height="50"></th>
                                                    <td>
                                                        <?php echo $v['company_name']; ?>
                                                    </td>
                                                    <th><?php echo $v['mobile']; ?></th>
                                                    <th><?php echo $v['contacts']; ?></th>
                                                    <td>
                                                        <?php echo date('Y-m-d H:i', $v['add_time']); ?>
                                                    </td>
                                                    <td>
                                                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                            <a class="green" href="<?php echo \Yii::$app->urlManager->createUrl(['user/company-detail', 'id' => $v['id']]); ?>">
                                                                <i class="icon-pencil bigger-130"></i>
                                                            </a>
                                                            <a class="green" href="<?php echo \Yii::$app->urlManager->createUrl(['task/list', 'company_id' => $v['id']]); ?>">
