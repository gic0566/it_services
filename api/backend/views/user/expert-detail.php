                    ...
                    <div class="col-xs-12 col-lg-12">
                        ...
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" value="<?php echo $data['true_name'] ?>" class="col-xs-10 col-sm-5" readonly="readonly">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 从业时间 </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" value="<?php echo $data['length_service'] ?>" class="col-xs-10 col-sm-5" readonly="readonly">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 专家等级 </label>
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" value="<?php echo $data['level_name'] ?>" class="col-xs-10 col-sm-5" readonly="readonly">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <textarea class="form-control" id="form-field-8" readonly="readonly"><?php echo $data['email'] ?> <?php echo $data['city'] ?> <?php echo $data['district'] ?> <?php echo $data['address'] ?></textarea>
                                </div>                            
                            </div>
